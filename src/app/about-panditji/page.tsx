  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="YOUR_WEBSITE_URL/about" /> {/* IMPORTANT: Replace with your actual live URL */}
        ...
        <link rel="canonical" href="YOUR_WEBSITE_URL/about" /> {/* IMPORTANT: Replace with your actual live URL */}
      </Head>
